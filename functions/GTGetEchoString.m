function string = GTGetEchoString(windowPtr, msg, x, y, textColor, bgColor, useKbCheck, varargin)
...
% Write the message
DrawFormattedText(windowPtr, msg,x,y,textColor,100, [],[],2);
...
while true
    ...
    output = [msg, ' ', string];      
    DrawFormattedText(windowPtr, output,x,y,textColor,100, [],[],2);
